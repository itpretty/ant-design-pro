    ...
    <PageHeaderWrapper>
      <Card title="">
        <Printer>
          ...
          >
            <Field name="total" type="number" required title="Total" x-component="NumberPicker" />
            <Field name="count" type="number" required title="Count" x-component="NumberPicker" />
            <Field name="price" type="number" required title="Price" x-component="NumberPicker" />
            <FormButtonGroup>
              <Submit />
              <Reset />
            </FormButtonGroup>
      ...
      <Card title={formatMessage({ id: 'formily.demo.intro' })}>
        <Paragraph>
          <ul className="react-demo-ul">
            <li className="react-demo-li">循環聯動，其實也是可以歸一到一對一聯動的</li>
          </ul>
        </Paragraph>
      </Card>
    </PageHeaderWrapper>
