        ...
        <Printer>
          ...
          >
            <Field
              ...
              x-component="Select"
            />
            <Field type="string" name="bb" visible={false} title="BB" x-component="Input" />
      ...
      <Card title={formatMessage({ id: 'formily.demo.intro' })}>
        <Paragraph>
          <ul className="react-demo-ul">
            <li className="react-demo-li">Field 組件visible 屬性可以控制初始顯示狀態</li>
            <li className="react-demo-li">BB的顯示受外部異步事件所控制</li>
            <li className="react-demo-li">
              CC 的顯示隱藏狀態受AA 的值控制，CC 的值受AA
              的附加信息所控制，同時整體聯動依賴一個外部異步事件
            </li>
            <li className="react-demo-li">使用rxjs 操作符combineLatest 可以解決聯動異步依賴問題</li>
          </ul>
        </Paragraph>
      </Card>
    </PageHeaderWrapper>
