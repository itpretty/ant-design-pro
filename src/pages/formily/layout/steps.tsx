        ...
        <Paragraph>
          <ul className="react-demo-ul">
            <li className="react-demo-li">
              使用 FormStep 組件需要傳入 dataSource，同時指定對應要控制的字段 name，這個 name
              屬性是一個 FormPathPattern，可以使用匹配語法匹配任何字段
            </li>
            <li className="react-demo-li">
              消費 FormStep 狀態，主要使用 FormSpy 來消費，借助 reducer 可以自定義狀態
            </li>
            <li className="react-demo- li">
              借助 actions.dispatch 可以手工觸發 FormStep 的生命週期鉤子
            </li>
          </ul>
        </Paragraph>
      </Card>
