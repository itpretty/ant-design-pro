            ...
            <FormCard title="基本信息">
              ...
              >
                ...
                <Field
                  ...
                  type="array"
                  required
                  default={[{ phone: '010-1234 5678' }, { phone: '010-1234 5678' }]}
        ...
        <Paragraph>
          <ul className="react-demo-ul">
            <li className="react-demo-li">
              結合自定義 ArrayList 以及 MegaLayout 的在柵格場景下的應用
            </li>
            <li className="react-demo -li">配合響應式佈局，能夠根據屏幕寬度進行自適應</li>
            <li className="react-demo-li">
              在 ArrayList 場景下，如何通過 Field（object）來改變 columns
            </li>{' '}
          </ul>
        </Paragraph>
      </Card>
