          ...
          >
            ...
            <FormCard title="高级信息" name="detailCard">
              ...
              <FormBlock title="区块">
                ...
                <Field name="eee2" type="string" title="字段6" x-component="Input" />
              </FormBlock>
            </FormCard>
            <Field
              name="sign"
              ...
              x-component-props={{
                children: "{{text('确认签署',link('《xxxx协议》','https://taobao.com','_blank'))}}",
              }}
        ...
        <Paragraph>
          <ul className="react-demo-ul">
            <li className="react-demo-li">
              抽象了幾個可複用的富文本工具方法，主要用在表達式中使用，可以快速實現很多簡單的富文本文案場景
            </li>
            <li className="react-demo-li">
              每個 Field 都可以配一個 x-props.addonAfter，可以給組件尾部追加文案
            </li>
            <li className="react -demo-li">
              FormCard 是卡片式佈局，FormBlock 是屬於內聯式卡片佈局
            </li>
          </ul>
        </Paragraph>
      </Card>
